	...
	let fsizedoc = '1'.repeat(10)    
     ...
     if (buffer) try { (type = await conn.getFile(buffer), buffer = type.data) } catch { buffer = buffer }
          ...
          forwardedNewsletterMessageInfo: {
            newsletterJid: '120363334220345206@newsletter',
            newsletterName: '𝐌𝐑 𝐇𝐀𝐌𝐙𝐀 𝐁𝐎𝐓 💫', 
            serverMessageId: '' }, 
                ...options
                }
                })
...
let canalId = ["120363334220345206@newsletter", "120363334220345206@newsletter", "120363334220345206@newsletter", "120363334220345206@newsletter", "120363334220345206@newsletter"]
let canalNombre = ["𝐌𝐑 𝐇𝐀𝐌𝐙𝐀 𝐁𝐎𝐓 💫", "دوس بــقــلــب جــامــد 😂⚡", "أضــغــط هــنــا 🤩", "𝐌𝐑 𝐇𝐀𝐌𝐙𝐀 𝐁𝐎𝐓 ✨", "قـنـاتـي عـلـي الـواتـسـاب ✅⚡"]
